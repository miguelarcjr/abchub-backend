...
export interface ApiCapituloCapitulo extends Schema.CollectionType {
...
export interface ApiComentarioComentario extends Schema.CollectionType {
  ...
  attributes: {
    ...
    conteudo: Attribute.String;
    data_envio: Attribute.DateTime;
    user: Attribute.Relation<
      'api::comentario.comentario',
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    mensagem: Attribute.Relation<
      'api::comentario.comentario',
      'manyToOne',
